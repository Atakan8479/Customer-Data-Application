...
-- I define the readTextFile function to read the data from filePath
...
-- this code defines a data type which represents the customer's data
...
data Customer = Customer 
    ...
    , balance :: Double
    , riskNote :: String
    }deriving Show        -- this part , which in type class, allows the system to print the customer's data to the console

-- List of customers
-- this function allows us to use all 100 customers in our other modules
